                            ...
                            <div class="card-body p-0">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($discount->onlyuser_id===1)
                                                Solo usuarios
                                            @endif
                                            @if($discount->onlyuser_id===2)
                                                Todos
                                            @endif
                                        </td>
                                        <td class="text-right py-0 align-middle">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{route('discount.show',$discount->codigo)}}" class="btn btn-info mr-2"><i class="fas fa-edit"></i></a>
                                                <button href="" onclick="discount_delete(event,'{{$discount->codigo}}')" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
