...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <input id="codigo_discount" type="hidden" value="{{$codigo}}" readonly>
        <!-- Main content -->
                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="codigo" type="text" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <!-- select -->
                                            <div class="form-group">
                                                ...
                                                <input id="discount" type="text" class="form-control" placeholder="">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <!-- select -->
                                            <div class="form-group">
                                                <label>Público</label>
                                                <select class="form-control" id="onlyuser">
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mr-auto ml-auto mt-2">
                                            <button onclick="discount_update(event)" type="button" class="btn btn-primary btn-block"><i class="fa fa-save mr-2"></i>Actualizar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <script src="/template/dist/js/discount.js"></script>
    <!-- jQuery -->
