...
@section('body')
    ...
    <!-- Content Header (Page header) -->
        ...
        <input id="code_category" type="hidden" value="{{ $code }}" readonly>
                                ...
                                <form id="category-form">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input oninput="slug()" type="text" id="name" class="form-control" maxlength="50">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-12">
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <small class="form-text text-muted">
                                                                    Puedes subir varias imágenes y <strong>arrastrarlas</strong> para reordenar.  
                                                                    <span class="badge badge-success">La primera será la PRINCIPAL</span>.
                                                                </small>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <!-- 🖼️ Lista de imágenes existentes y nuevas con drag & drop -->
                                                    <div id="sortable-images" class="row">
                                                        @if(isset($categoryImages) && count($categoryImages) > 0)
                                                            @foreach($categoryImages as $img)
                                                                <div class="col-sm-3 text-center mb-3 image-item" data-id="{{ $img->id }}">
                                                                    <div class="card p-2">
                                                                        <div class="position-relative">
                                                                            <img src="{{ $img->path }}" class="img-fluid img-thumbnail mb-2" style="max-height:150px;">
                                                                            @if($loop->first || $img->type === 'principal')
                                                                                <span class="badge badge-success position-absolute" style="top:5px; left:5px;">PRINCIPAL</span>
                                                                            @else
                                                    ...
                                                    <!-- Preview dinámico de nuevas imágenes -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mr-auto ml-auto mt-2">
                                            <!-- <button onclick="category_update(event)" type="button" class="btn btn-primary btn-block">
                                                <i class="fa fa-save mr-2"></i>Actualizar
                                            </button> -->
                                            <button id="btn-save" type="button" class="btn btn-primary btn-block" onclick="category_update(event)">
    ...
    <script src="/template/dist/js/category.js"></script>
