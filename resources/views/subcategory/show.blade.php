...
@section('body')
    ...
    <!-- Content Header (Page header) -->
        ...
        <input id="code_subcategory" type="hidden" value="{{ $code }}" readonly>
                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <form id="subcategory-form">
                                    <input type="hidden" id="code_subcategory" value="{{ $code }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input oninput="slugSubcategory()" type="text" id="name" class="form-control" maxlength="50">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                            ...
                                            <div class="card card-primary">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <small class="form-text text-muted">
                                                                    Puedes subir varias imágenes. Arrastra para reordenar y la primera será principal.
                                                                </small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="sortable-images" class="row">
                                                        @if(isset($subcategoryImages) && count($subcategoryImages) > 0)
                                                            @foreach($subcategoryImages as $img)
                                                                <div class="col-sm-3 text-center mb-3 image-item" data-id="{{ $img->id }}">
                                                                    <div class="card p-2">
                                                                        <div class="position-relative">
                                                                            ...
                                                                            <span class="badge {{ $loop->first ? 'badge-success' : 'badge-secondary' }} position-absolute" style="top:5px; left:5px;">
                                                                                {{ $loop->first ? 'PRINCIPAL' : 'SECUNDARIA' }}
                                                                            </span>
                                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mr-auto ml-auto mt-2">
                                            <!-- <button onclick="subcategory_update(event)" type="button" class="btn btn-primary btn-block">
                                                <i class="fa fa-save mr-2"></i>Actualizar
                                            </button> -->
                                            <button id="btn-save" type="button" class="btn btn-primary btn-block" onclick="subcategory_update(event)">
    ...
    <script src="/template/dist/js/subcategory.js"></script>
