                    ...
                    <div class="col-12">
                        ...
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">DETALLE / EDITAR DISTRITO</h3>
                            </div>

                            <div class="card-body">
                                <form id="formDistritoShow">
                                    {{-- ID oculto para JS --}}
                                    <input type="hidden" id="distrito_id" value="{{ $district->id }}">
                                                ...
                                                <select id="provincia" class="form-control" required>
                                                    ...
                                                    @foreach($provinces as $province)
                                                        <option value="{{ $province->id }}"
                                                            {{ $district->province_id == $province->id ? 'selected' : '' }}>
                                                            {{ $province->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <select id="delivery" class="form-control">
                                                    <option value="1" {{ $district->delivery ? 'selected' : '' }}>Sí</option>
                                                    <option value="0" {{ !$district->delivery ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input id="precio" type="number" step="0.01" min="0"
                                                    class="form-control" value="{{ $district->price }}">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="mt-3">
                                        <button type="button" onclick="delivery_update(event)" class="btn btn-primary">
                                            <i class="fa fa-save mr-2"></i>Actualizar
                                        </button>
                                        <a href="{{ route('districts.index') }}" class="btn btn-secondary">Volver</a>
                                    </div>
                                </form>
                            </div>
                        </div>
