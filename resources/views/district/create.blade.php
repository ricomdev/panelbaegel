                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card card-warning">
                            ...
                            <div class="card-body">
                                <form id="formDistritoCreate" data-action="{{ route('districts.store') }}">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <label>Distrito</label>
                                                <input id="nombre" name="name" type="text" class="form-control" placeholder="Ej. Miraflores" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <select id="provincia" name="province_id" class="form-control" required>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input id="precio" name="price" type="number" step="0.01" min="0" class="form-control" placeholder="0.00">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mr-auto ml-auto mt-2">
                                            <button onclick="delivery_create(event)" type="button" class="btn btn-primary btn-block">
                                                <i class="fa fa-save mr-2"></i>Crear
                                            </button>
                                        </div>
                                    </div>
                                </form>
