...
@section('body')
    ...
    <div class="content-wrapper">
        ...
        <input id="codigo_delivery" type="hidden" value="{{$codigo}}" readonly>
        <!-- Main content -->
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 mr-auto ml-auto mt-2">
                                            <button onclick="delivery_update(event)" type="button" class="btn btn-primary btn-block"><i class="fa fa-save mr-2"></i>Actualizar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
