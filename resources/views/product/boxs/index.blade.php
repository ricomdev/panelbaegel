                    ...
                    <div class="col-12">
                        <div class="card card-warning">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">LISTA DE BOXES 1 SABOR</h3>
                                <a href="{{ route('product.boxs.create') }}" class="btn btn-success btn-sm text-white font-weight-bold">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right py-0 align-middle">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="{{ route('product.boxs.show', $product->code) }}" class="btn btn-info mr-2">
